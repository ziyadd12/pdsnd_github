...
def get_filters():
    ...
    # user should select a city (chicago, new york city, washington). HINT: Use a while loop to handle invalid inputs
    while True:
    ...
    # user should input the day (all, monday, tuesday, ... sunday)
    while True:
        day = input(
